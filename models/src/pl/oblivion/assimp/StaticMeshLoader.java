...
public class StaticMeshLoader {
	...
	private static TexturedMesh processMesh(AIMesh aiMesh, List<Material> materials) {
		...
		StaticMeshData mesh = new StaticMeshData(listIntToArray(indices), listToArray(vertices), listToArray(textures),
				listToArray(normals), null);
