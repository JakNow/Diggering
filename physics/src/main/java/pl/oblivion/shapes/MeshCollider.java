...
public class MeshCollider extends CollisionShape {
    ...
    private static Face.Vertex getVertex(int index, MeshData meshData) {
        Vector3f pos = new Vector3f(meshData.vertices[index * 3], meshData.vertices[index * 3 + 1], meshData.vertices[index * 3 + 2]);
        Vector3f norm = new Vector3f(meshData.normals[index * 3], meshData.normals[index * 3 + 1], meshData.normals[index * 3 + 2]);
