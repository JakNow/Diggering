...
public class CollisionMeshShader extends ShaderProgram {
	...
	public CollisionMeshShader() {
		super(new MyFile(SimpleApp.properties.getProperty("shader.collision.vertex")),
				new MyFile(SimpleApp.properties.getProperty("shader.collision.fragment")), "in_position",
				"in_textures");
